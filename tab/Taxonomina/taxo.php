...
<body><br>
    ...
    <nav>
    <div class="wrapper">
      <div class="logo"><a href="#"> Taxonomina </a></div>
            ...
            <div class="content">
              <div class="row">
                <ul class="mega-links">
                  ...
                  <li><a href="taxo.php">Taxonomina</a></li>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Añadir Nueva Taxonomina</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="valTaxo.php" method="POST">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Nombre Taxonomina</label>
                            <input type="text" class="form-control" name="nom_taxonomina">
                        </div>
                        <div class="mb-3">
  ...
  <tbody class="text-center">
    <?php
      ...
      <tr>
        <td><?php echo $row['ID_Taxonomina']; ?></td>
        <td><?php echo $row['nom_taxonomina']; ?></td>
