...
<body>
    ...
    <div class="container text-center">
        ...
        <?php
            ...
            $sql = "SELECT * FROM tipo WHERE ID_Tipo =".$_GET['ID_Tipo'];
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control text-center" name="Transaccional" value="<?php echo $row['Transaccional']; ?>" placeholder="Actualizar Transaccional">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Estrategico</label>
            <input type="text" class="form-control text-center" name="Estrategico " value="<?php echo $row['Estrategico ']; ?>" placeholder="Actualizar Estrategico">
        </div>
        <div class="mb-3">
        ...
        <div class="text-center">
            <a href="tipo.php" class="btn btn-danger">Back</a>
