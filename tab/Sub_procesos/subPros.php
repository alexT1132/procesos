...
<body><br>
    ...
    <nav>
    <div class="wrapper">
      <div class="logo"><a href="#"> Subprocesos </a></div>
            ...
            <div class="content">
              <div class="row">
                <ul class="mega-links">
                  ...
                  <li><a href="subPros.php">Sub_procesos</a></li>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Añadir Nuevo Subproceso</h1>
