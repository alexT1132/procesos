...
<body><br>
    ...
    <nav>
    <div class="wrapper">
      <div class="logo"><a href="#">Temporalidad</a></div>
            ...
            <div class="content">
              ...
              <div class="row">
                <ul class="mega-links">
                  ...
                  <li><a href="tem.php">Temporalidad</a></li>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Añadir Nueva Temporalidad</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="valTemp.php" method="POST">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Nom_Temporalidad</label>
                            <input type="text" class="form-control" name="Nom_Temporalidad" >
                        </div>
  ...
  <tbody class="text-center">
    <?php
      ...
      <tr>
        ...
        <td>
          <a href="edit.php?ID_Temporalidad=<?php echo $row['ID_Temporalidad']?>" class="btn btn-warning">
            <i class='bx bxs-edit'></i>
          </a>
          <a href="delete.php?ID_Temporalidad=<?php echo $row['ID_Temporalidad']?>" class="btn btn-danger">
