...
<body><br>
    ...
    <nav>
    <div class="wrapper">
      <div class="logo"><a href="#"> Procesos </a></div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="valproceso.php" method="POST">
                        <div class="mb-3">
                            <input type="text" class="form-control" name="Nom_Procesos" id="Nom_Procesos" placeholder="Inserte proceso">
                        </div>
  ...
  <tbody class="text-center">
    <?php
      ...
      <tr>
        ...
        <td>
          <a href="edit.php?ID_Procesos=<?php echo $row['ID_Procesos']?>" class="btn btn-warning">
            <i class='bx bxs-edit'></i>
          </a>
          <a href="delete.php?ID_Procesos=<?php echo $row['ID_Procesos']?>" class="btn btn-danger">
