...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE frecuencia set Nom_Valor = '$Nom_Valor' WHERE ID_Valor = $ID_Valor";
    ...
    <div class="col-md-4 mx-auto">
      <div class="card card-body">
        <form action="edit.php?ID_Valor=<?php echo $_GET['ID_Valor']; ?>" method="POST">
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Nom_Valor</label>
                <input type="text" class="form-control" name="Nom_Valor" value="<?php echo $Nom_Valor; ?>" placeholder="Actualizar Nombre">
            </div>
