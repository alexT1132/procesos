<?php
    ...
    if (isset($_SESSION['formulario1']) && isset($_SESSION['formulario2'])) {
        ...
        $query = "UPDATE usuario_cliente SET Nombre = '$Nombre', Apellido = '$Apellido', Nom_Unidad_Negocio = '$Nom_Unidad_Negocio', Email = '$Email', Area = '$Area', Nom_Direcciones = '$Nom_Direcciones', Nom_Nuevo_Puesto = '$Nom_Nuevo_Puesto', Nom_funcion = '$Nom_funcion', input = '$input', 
    sistema = '$sistema', rol = '$rol', tiempo = '$tiempo', val_Frec = '$val_Frec', vol = '$vol', t_h = '$t_h', ftes = '$ftes' WHERE ID_empleado = {$formulario2['ID_empleado']}";
