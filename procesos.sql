...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-12-2023 a las 17:51:20
...
INSERT INTO `consultas` (`ID`, `procesos`, `subprocesos`, `actividades`, `val_Frec`, `input`, `sistema`, `rol`, `tiempo`, `vol`, `t_h`, `ftes`, `estado`) VALUES
...
--
ALTER TABLE `usuario_cliente`
  MODIFY `ID_empleado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=147;
