...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-12-2023 a las 19:40:55
...
INSERT INTO `consultas` (`ID`, `procesos`, `subprocesos`, `actividades`, `estado`) VALUES
(0, 'Gestionar Contratos', 'Gestionar contrato de servicios administrativos y de zafra', 'Firmar contrato', '1'),
...
(141, 'aaaaaa', 'aaaaa', 'CIS', 'aaaaaaa@gmail.com', 'ti', '', 'Analista de abasto', 'Gestionar Contratos', 'Direccion de Cadena de Suministro', 'Gestionar contrato de servicios administrativos y ', 'Abastecimientos', '4', 'aaaa', 'aaaa', 'Supervisar', '10', '2', '80', '0.5');
...
--
ALTER TABLE `usuario_cliente`
  MODIFY `ID_empleado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=142;
