...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-10-2023 a las 01:53:02
...
(1, 'Recibir solicitud y propuestas', '', '', ''),
(2, 'Validar posible transportista', '', '', ''),
(3, 'Visitar instalaciones', '', '', ''),
(4, 'Validar documentación', '', '', ''),
(5, 'Solicitar información correcta', '', '', ''),
(6, 'Llenar contrato', '', '', ''),
(7, 'Enviar contrato y documentación para validación', '', '', ''),
(8, 'Enviar contrato y documentación para validación', '', '', ''),
(9, 'Corregir contrato', '', '', ''),
(10, 'Firmar contrato', '', '', ''),
(11, 'Validar propuesta del proveedor', '', '', ''),
(12, 'Solicitar nueva cotización/propuesta  ', '', '', ''),
(13, 'Negociar con proveedor', '', '', ''),
(14, 'Recibir y validar documentación', '', '', '');
...
(4, 'Analista de abasto', 1, 'Recibir solicitud y propuestas');
...
(1, 'Gestionar contrato de transportista', 1, 'Gestionar contratos', 1, 'Recibir solicitud y propuestas');
...
(7, 'Transaccional', 1, 'Recibir solicitud y propuestas'),
(9, 'Estrategico', 14, '');
...
--
ALTER TABLE `sub_proceso`
  MODIFY `ID_subProcesos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
