...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-12-2023 a las 22:05:50
...
(0, 'Gestionar Contratos', 'Gestionar contrato de servicios administrativos y de zafra', 'Firmar contrato', '', '0'),
(1, 'Gestionar Contratos', 'Gestionar contrato de transportistas', 'Recibir solicitud y propuestas', '', '0'),
(2, 'Gestionar Contratos', 'Gestionar contrato de transportistas', 'Validar posible transportista', '', '0'),
(3, 'Gestionar Contratos', 'Gestionar contrato de transportistas', 'Visitar instalaciones', '', '0'),
(4, 'Gestionar Contratos', 'Gestionar contrato de transportistas', 'Validar documentación', '', '0'),
(5, 'Gestionar Contratos', 'Gestionar contrato de transportistas', 'Solicitar información correcta', '', '0'),
(6, 'Gestionar Contratos', 'Gestionar contrato de transportistas', 'Llenar contrato', '', '0'),
(7, 'Gestionar Contratos', 'Gestionar contrato de transportistas', 'Enviar contrato y documentación para validación', '', '0'),
(8, 'Gestionar Contratos', 'Gestionar contrato de transportistas', 'Corregir contrato', '', '0'),
(9, 'Gestionar Contratos', 'Gestionar contrato de transportistas', 'Firmar contrato', '', '0'),
(10, 'Gestionar Contratos', 'Gestionar contratos de bodegas de azúcar', 'Validar propuesta del proveedor', '', '0'),
(11, 'Gestionar Contratos', 'Gestionar contratos de bodegas de azúcar', 'Solicitar nueva cotización/propuesta', '', '0'),
(12, 'Gestionar Contratos', 'Gestionar contratos de bodegas de azúcar', 'Negociar con proveedor', '', '0'),
(13, 'Gestionar Contratos', 'Gestionar contratos de bodegas de azúcar', 'Recibir y validar documentación', '', '0'),
(14, 'Gestionar Contratos', 'Gestionar contratos de bodegas de azúcar', 'Solicitar información correcta', '', '0'),
(15, 'Gestionar Contratos', 'Gestionar contratos de bodegas de azúcar', 'Revisar contrato firmado', '', '0'),
(16, 'Gestionar Contratos', 'Gestionar contratos de bodegas de azúcar', 'Actualizar contrato', '', '0'),
(17, 'Gestionar Contratos', 'Gestionar contratos de bodegas de azúcar', 'Llenar contrato', '', '0'),
(18, 'Gestionar Contratos', 'Gestionar contratos de bodegas de azúcar', 'Firmar contrato', '', '0'),
(19, 'Gestionar Contratos', 'Gestionar contratos de bodegas de azúcar', 'Enviar contrato y documentación para validación', '', '0'),
(20, 'Gestionar Contratos', 'Gestionar contratos de bodegas de azúcar', 'Corregir contrato', '', '0'),
(21, 'Gestionar Contratos', 'Gestionar contratos de bodegas de azúcar', 'Firmar contrato', '', '0'),
(22, 'Gestionar Contratos', 'Gestionar contrato de servicios administrativos y de zafra', 'Recibir propuesta de proveedor', '', '0'),
(23, 'Gestionar Contratos', 'Gestionar contrato de servicios administrativos y de zafra', 'Negociar condiciones comerciales', '', '0'),
(24, 'Gestionar Contratos', 'Gestionar contrato de servicios administrativos y de zafra', 'Determinar mejor opción', '', '0'),
(25, 'Gestionar Contratos', 'Gestionar contrato de servicios administrativos y de zafra', 'Llenar contrato', '', '0'),
(26, 'Gestionar Contratos', 'Gestionar contrato de servicios administrativos y de zafra', 'Validar documentación', '', '0'),
(27, 'Gestionar Contratos', 'Gestionar contrato de servicios administrativos y de zafra', 'Solicitar información correcta', '', '0'),
(28, 'Gestionar Contratos', 'Gestionar contrato de servicios administrativos y de zafra', 'Enviar contrato y documentación para validación', '', '0'),
(29, 'Gestionar Contratos', 'Gestionar contrato de servicios administrativos y de zafra', 'Corregir contrato', '', '0'),
...
(137, 'aaa', 'sss', 'SAISA', 'aaaaaaa@gmail.com', 'aaaaaa', '', 'Analista de abasto', 'Gestionar Contratos', 'Direccion de Cadena de Suministro', 'Gestionar contrato de servicios administrativos y ', 'Abastecimientos', '4', 'aaa', 'x', 'Supervisar', '10', '2', '80', '0.5');
...
--
ALTER TABLE `usuario_cliente`
  MODIFY `ID_empleado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=138;
